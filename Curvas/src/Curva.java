...
public final class Curva extends JFrame {
    ...
    public void drawCurve(int cantP, Graphics g, Color c) {
        double puntos = 300 / cantP;
        double x1 = 0,y1 = 0, y2 = 0;

        for (double x2=0; x2<=getWidth(); x2+=puntos){
            y2 = getHeight()-300 * Math.sin(0.007*x2);
