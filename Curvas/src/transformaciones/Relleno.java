...
public class Relleno extends JPanel implements Runnable{
    double fps = 60.0;
    ...
    public static void main(String[] args) {
        ...
        frame.setTitle("Escalar 3D 20110374");
        frame.setResizable(false);
        Relleno relleno = new Relleno();
        relleno.setDoubleBuffered(true);
        frame.add(relleno);
        frame.pack();
    ...
    public void update(Graphics g){
        ...
        drawCube(res,new double[]{30,50,120},50,50,g,Color.blue);
    ...
    public void drawCube(double[][] puntos,double[] direccion,double origenX,double origenY,Graphics g, Color c){
        ...
        //FRONT
        lineaBresenham(result[0][0], result[1][0], result[0][1], result[1][1], g, c);
        lineaBresenham(result[0][1], result[1][1], result[0][2], result[1][2], g,c);
        lineaBresenham(result[0][2], result[1][2], result[0][3], result[1][3], g, c);
        lineaBresenham(result[0][3], result[1][3], result[0][0], result[1][0], g, c);

        //BACK
        lineaBresenham(result[0][4], result[1][4], result[0][5], result[1][5], g, c);
        lineaBresenham(result[0][5], result[1][5], result[0][6], result[1][6], g, c);
        lineaBresenham(result[0][6], result[1][6], result[0][7], result[1][7], g, c);
        lineaBresenham(result[0][7], result[1][7], result[0][4], result[1][4], g, c);

        //LATERAL
        lineaBresenham(result[0][0], result[1][0], result[0][4], result[1][4], g, c);
        lineaBresenham(result[0][1], result[1][1], result[0][5], result[1][5], g, c);
        lineaBresenham(result[0][2], result[1][2], result[0][6], result[1][6], g, c);
        lineaBresenham(result[0][3], result[1][3], result[0][7], result[1][7], g, c);
