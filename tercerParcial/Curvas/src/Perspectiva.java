...
public class Perspectiva extends JFrame {
    ...
    public void paint(Graphics g) {
        ...
        drawCube(coordenadas,new float[]{50.0f,50.0f,50.0f},500,200,g,Color.BLUE);
    ...
    public float[][] multiplicarMatriz(float[][] matriz, float[] direccion,int origenX,int origenY){
        ...
        for(int i=0;i<matriz.length;i++){
            result[i][0] = (direccion[0] + (matriz[i][0] - direccion[0]) * (-direccion[2] / (matriz[i][2]-direccion[2]))) + origenX;
            result[i][1] = (direccion[1] + (matriz[i][1] - direccion[1]) * (-direccion[2] / (matriz[i][2]-direccion[2]))) + origenY;
