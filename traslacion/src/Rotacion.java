...
public class Rotacion extends JFrame implements Runnable{
    private Image fondo;
    private Image buffer;
    private Thread hilo;
    private BufferedImage bufferedImage;
    double[] p1 = {650.0, 50.0};
    double[] p2 = {700.0, 50.0};
    double[] p3 = {700.0, 100.0};
    double[] p4 = {650.0, 100.0};
    double xangle = Math.PI, yangle = Math.PI;
        ...
        while (true){
            try{
                while(xc<=xangle) {
                    repaint();
                    hilo.sleep(50);
                    xc += Math.toRadians(0.7);
                    System.out.println("xtheta: "+xc+" ytheta: "+yc);
    ...
    public void update(Graphics g){
        ...
        double[][] identity = {
                {Math.cos(xc), -Math.sin(xc),   0},
                {Math.sin(xc),  Math.cos(xc),   0},
                {           0,             0, 1.0}
        };
